...
import { BreadboardGrid } from './src/engine/CircuitNode.js?v=1290';
import { MNASolver } from './src/engine/MNASolver.js?v=1290';
import { FFT } from './src/engine/FFT.js?v=1290';
import { Resistor, Capacitor, DCSource, SwitchComponent, LEDComponent, Wire, Diode, ZenerDiode, Potentiometer, DIPChip, BJTTransistor, IC_CATALOG, TRANSISTOR_CATALOG } from './src/components/ComponentModels.js?v=1290';
import { BreadboardCanvas } from './src/ui/BreadboardCanvas.js?v=1290';
import { OscilloscopeCanvas } from './src/ui/OscilloscopeCanvas.js?v=1290';
import { ContinuityTester } from './src/ui/ContinuityTester.js?v=1290';
import { SPICEExporter } from './src/components/SPICEExporter.js?v=1290';
import { AICopilot } from './src/components/AICopilot.js?v=1290';
import { CircuitSerializer } from './src/components/CircuitSerializer.js?v=1290';
...
class AppController {
    ...
    applyLoadedCircuit(restored) {
        ...
        this.syncScopeChannelVisibility();
        this.warmupSimulationBuffer(60000); // 60,000 steps = 300ms full simulation history for instant 3CH waveforms!
