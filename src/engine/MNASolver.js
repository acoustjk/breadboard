                ...
                if (icType === 'NE555') {
                    ...
                    if (nOut) {
                        ...
                        if (iOut >= 0) {
                            ...
                            const isU1_SineOsc = compId === 'U1' || compId === 'IC_CATALOG_1' || (comp.icType === 'LF356' && (pinStr.includes('F17') || pinStr.includes('F18')));
                            const isU3_RelaxationOsc = compId === 'U3' || compId === 'IC_CATALOG_29' || compId === 'IC_CATALOG_72' || pinStr.includes('F47') || pinStr.includes('F46') || pinStr.includes('F40') || pinStr.includes('F42');
